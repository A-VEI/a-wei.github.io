(function () {
        ...
        const l = [
            {
              path: "/",
              name: "index",
              component: () => n.e(533).then(n.bind(n, 533)),
              meta: { title: "My Icon" },
            },
          ],
          d = (0, s.p7)({ history: (0, s.r5)(), routes: l });
        d.beforeEach((e, t, n) => {
          "string" === typeof e.meta?.title && (document.title = e.meta?.title),
            n();
        });
        var p = d,
          m = n(3907),
          ...
          h = n(26);
        n(4415);
        (0, r.ri)(f).use(v).use(p).use(h.Z).mount("#app");
      },
    },
    t = {};
  function n(r) {
  ...
  (n.m = e),
    ...
    (function () {
      n.u = function (e) {
        return "assets/js/" + e + ".6eefca37.js";
      };
    })(),
    (function () {
      n.miniCssF = function (e) {
        return "assets/css/" + e + ".b1e17d84.css";
      };
    })(),
    (function () {
      n.g = (function () {
    ...
    (function () {
      ...
      var t = function (t, r) {
        ...
        r = (self["webpackChunkmyicon"] = self["webpackChunkmyicon"] || []);
